        ...
        bloco.innerHTML = `
            <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                ...
                <div style="flex: 1; min-width: 260px;">
                    <p style="font-size: 12px; color: #999; margin-bottom: 5px;">PRODUTO NOVO (suspeito)</p>
            ...
            <div style="display: flex; gap: 10px; margin-top: 15px;">
                ...
                <button onclick="editarProduto(${produtoSuspeito.id})">Editar</button>
                <button onclick="excluirProduto(${produtoSuspeito.id})">Excluir produto novo</button>
            </div>
        `;
